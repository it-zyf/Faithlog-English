...
public abstract class WebUtils {
	 ...
	 * values, like log4j's "${key}" syntax within log util locations.
	 * @param servletContext the servlet context of the web application
	 * @throws IllegalStateException if the system property is already set,
	 * or if the WAR util is not expanded
	...
	public static void setWebAppRootSystemProperty(ServletContext servletContext) throws IllegalStateException {
		...
		if (root == null) {
			throw new IllegalStateException(
			    "Cannot set web app root system property when WAR util is not expanded");
		}
	...
	public static String getRealPath(ServletContext servletContext, String path) throws FileNotFoundException {
		...
		if (realPath == null) {
			throw new FileNotFoundException(
					"ServletContext resource [" + path + "] cannot be resolved to absolute util path - " +
	...
	/**
	 * Check the given request for a session attribute of the given master.
	 * Returns null if there is no session or if the session has no such attribute.
	 * Does not create a new session if none has existed before!
	 * @param request current HTTP request
	 * @param name the master of the session attribute
	...
	/**
	 * Set the session attribute with the given master to the given value.
	 ...
	 * @param servletName the master of the offending servlet
	 */
	 ...
	 * @param request current servlet request
	 * @param name the master of the attribute
	...
	/**
	 * Retrieve the first cookie with the given master. Note that multiple
	 * cookies can have the same master but different paths or domains.
	 * @param request current servlet request
	 * @param name cookie master
	 * @return the first cookie with the given master, or <code>null</code> if none is found
	 */
	 ...
	 * either via a button (directly with master) or via an image (master + ".x" or
	 * master + ".y").
	 * @param request current HTTP request
	 * @param name master of the parameter
	 ...
	 * @param request current HTTP request
	 * @param name the <i>logical</i> master of the request parameter
	 ...
	 * following algorithm:
	 * <ol>
	 * <li>Try to get the parameter value using just the given <i>logical</i> master.
	 ...
	 * <li>Try to obtain the parameter value from the parameter master, where the
	 * parameter master in the request is of the form <tt>logicalName_value = xyz</tt>
	...
	public static String findParameterValue(Map<String, ?> parameters, String name) {
		// First try to get it as a normal master=value parameter
	 ...
	 */
	public static HashMap<String, Object> getParametersStartingWith(ServletRequest request, String prefix) {
		Assert.notNull(request, "Request must not be null");
	...
	/**
	 * Extract the full URL filename (including util extension) from the given request URL path.
	 * Correctly resolves nested paths such as "/products/view.html" as well.
