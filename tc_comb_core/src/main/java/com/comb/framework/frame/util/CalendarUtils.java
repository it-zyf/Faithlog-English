...
/**
 * 
 * Description: 提供有关时间操作的类 Copyright (c) Department of Research and
 * Development/Beijing/Digital Heaven. All Rights Reserved.
 * 
 * @version 1.0 Nov 5, 2008 11:14:47 AM by 范文彬（fwb@d-heaven.com）创建
 */
public class CalendarUtils {
	 ...
	 * 
	 * @Version1.0 Oct 29, 2008 11:49:58 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param str
	 * @return
	 * @throws ParseException
	 */
	public static Calendar convertCalendarOne(String str){
	 ...
	 * @throws ParseException
	 */
	public static Calendar convertCalendarTwo(String str){
		Calendar c = Calendar.getInstance();
		try {
	 ...
	 * 
	 * @Version1.0 Nov 5, 2008 11:20:35 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param str
	 * @return
	 * @throws ParseException
	 */
	 ...
	 * 
	 * @Version1.0 Nov 5, 2008 11:22:28 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param str
	 * @param pattern
	 *            格式化类型
	 * @return
	 ...
	 * 
	 * @Version1.0 Oct 29, 2008 11:53:08 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 * @return
	 */
	public static String convertStrOne(Calendar c) {
	 ...
	 * @return
	 */
	public static String convertStrTwo(Calendar c) {
	 ...
	 * 
	 * @Version1.0 Nov 5, 2008 11:25:48 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Nov 5, 2008 11:26:51 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 * @param pattern
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Oct 29, 2008 11:44:59 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param firstdaytime
	 * @return
	 * @throws ParseException
	 */
	 ...
	 * 
	 * @Version1.0 Oct 29, 2008 11:46:35 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param lastdaytime
	 * @return
	 * @throws ParseException
	 */
	 ...
	 * 
	 * @Version1.0 Oct 30, 2008 3:51:01 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 *            时间
	 * @param period
	 *            时间差,以月份表示
	...
	public static Calendar getModifiedCalendar(String date, String premonth){
		...
		if (month <= p) {
			...
			month = month - p - 1;
		int day = daysInMonth(year, month);
		String str = String.valueOf(year) + "-" + String.valueOf(month) + "-"
				+ String.valueOf(day);
		Calendar obj = convertLastCalendar(str);
		return obj;
	}
	 ...
	 * 
	 * @Version1.0 Nov 4, 2008 6:04:58 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param hour
	 * @param bool
	 * @return
	...
	public static Calendar getHourCalendar(String date, int hour, boolean isbegin){
		Calendar obj;
		if (date.length() > 10)
			obj = convertCalendarOne(date);
		else
			obj = convertCalendarTwo(date);
		if (hour > 23)
			hour = 23;
		if (hour < 0)
			hour = 0;
	 ...
	 * Description:
	 * 
	 * @Version1.0 May 31, 2009 11:19:19 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param obj
	 * @param hour
	 * @param isbegin
	 * @return
	 ...
	 * 
	 * @Version1.0 Nov 4, 2008 6:48:37 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param days
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Nov 5, 2008 9:37:44 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param weeks
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Nov 4, 2008 7:08:13 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param days
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Nov 4, 2008 7:39:28 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Nov 5, 2008 2:19:33 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param isbegin
	 *            是否零点
	 * @return
	 ...
	 * 
	 * @Version1.0 Jun 19, 2009 11:34:43 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param isbegin
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Jun 19, 2009 11:36:53 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param isbegin
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Nov 4, 2008 8:14:08 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param week
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 May 31, 2009 10:57:39 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param obj
	 * @return
	 */
	 ...
	 * Description:
	 * 
	 * @Version1.0 Jun 5, 2009 3:22:22 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param day
	 * @param last
	 * @return
	 */
	 ...
	 * Description:
	 * 
	 * @Version1.0 Jun 5, 2009 3:48:15 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 * @param last
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Dec 3, 2008 2:30:56 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 * @param day
	 * @return
	 */
	 ...
	 * Description: 增加年
	 * 
	 * @Version1.0 Feb 13, 2009 3:49:21 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param c
	 * @param year
	 * @return
	 */
	 ...
	 * Description: 增加年
	 * 
	 * @Version1.0 Feb 13, 2009 3:50:11 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param date
	 * @param year
	 * @return
	 */
	public static Calendar getAddYear(String date, int year) {
		Calendar c;
		if (date.length() > 10)
			c = convertCalendarOne(date);
		else
			c = convertCalendarTwo(date);
		c.add(Calendar.YEAR, year);
		return c;
	}
	 ...
	 * 
	 * @Version1.0 Jan 15, 2009 4:47:54 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param begin
	 * @param end
	 * @return
	 */
	public static int getInterval(String begin, String end) {
		Calendar first = convertCalendarTwo(begin);
		Calendar last = convertCalendarTwo(end);
	 ...
	 * Description:计算两个时间差的天数
	 * 
	 * @Version1.0 Jan 15, 2009 4:54:27 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param begin
	 * @param end
	 * @return
	 */
	 ...
	 * 
	 * @Version 1.0 Jan 29, 2012 6:50:55 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param begin
	 * @param end
	 * @return
	 */
	 ...
	 * Description:
	 * 
	 * @Version1.0 Sep 9, 2009 2:18:58 PM by 范文彬（fwb@d-heaven.com）创建
	 * @param begin
	 * @param end
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 May 31, 2009 10:49:00 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param begin
	 * @param end
	 * @return
	 */
	 ...
	 * 
	 * @Version1.0 Oct 29, 2008 11:56:05 AM by 范文彬（fwb@d-heaven.com）创建
	 * @param y_e_a_r
	 * @param m_o_n_t_h
	 * @return
	 */
	 ...
	 * Description:判断是否是周末
	 * 
	 * @Version1.0 Aug 29, 2008 10:03:43 AM 范文彬（v-fwb@d-heaven.com）创建
	 * @param _timeobj
	 ...
	 * 
	 * @Version1.0 Aug 29, 2008 10:38:44 AM 范文彬（v-fwb@d-heaven.com）创建
	 * @param _cfirst
	 * @return
	 */
	 ...
	 * 
	 * @Version 1.0 Aug 18, 2010 5:05:22 PM by 范文彬（fwb@d-heaven.com）创建
	 * @return
	 */
