...
//@Service
//@SuppressWarnings({"unchecked"})
public class TestSourceAdvisor extends StaticMethodMatcherPointcutAdvisor implements InitializingBean {
    ...
    public TestSourceAdvisor(){
        System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@ TestSourceAdvisor:" + ++newCount);
    }
...
//        System.out.println("TestSourceAdvisor matches :" + targetClass + " Mechod:" + method);
        Method m = method;
...
//        }
    ...
    public void afterPropertiesSet() throws Exception {
        System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@ TestSourceAdvisor: afterPropertiesSet : " + newCount);
