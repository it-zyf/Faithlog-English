...
public class AuthorizationAttributeSourceAdvisor extends StaticMethodMatcherPointcutAdvisor implements InitializingBean {
    ...
    @Autowired
    private AnnotationsMethodInterceptor annotationsMethodInterceptor;
    ...
    private boolean isAuthzAnnotationPresent(Method method) {
        for( Class<? extends Annotation> annotationClass : annotationsMethodInterceptor.getAnnotationClass() ) {
    ...
    public void afterPropertiesSet() throws Exception {
        Assert.notNull(annotationsMethodInterceptor, "annotationsMethodInterceptor must not be null!");
