...
//@Service
@Service
public class CasAnnotationsHandler implements InitializingBean {

	private static final Logger logger = LoggerFactory.getLogger(CasAnnotationsHandler.class);

	private Set<Class<? extends Annotation>> annotationSet = new HashSet<>();

	private static int newCount = 0;

	public CasAnnotationsHandler(){
		annotationSet.add(CasArround.class);
	}
