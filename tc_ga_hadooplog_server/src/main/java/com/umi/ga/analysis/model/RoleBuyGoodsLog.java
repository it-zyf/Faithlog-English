...
public class RoleBuyGoodsLog extends BaseEntity{

	private static final long serialVersionUID = -2101866801130323343L;
	...
	//
	private Integer itemNumPerGoods;
	//
	private String costMoneyType;
	//
	private String costMoneyNum;
	...
	public Integer getItemNumPerGoods() {
		return itemNumPerGoods;
	}

	public void setItemNumPerGoods(Integer itemNumPerGoods) {
		this.itemNumPerGoods = itemNumPerGoods;
	}
	...
	public String getCostMoneyNum() {
		return costMoneyNum;
	}

	public void setCostMoneyNum(String costMoneyNum) {
