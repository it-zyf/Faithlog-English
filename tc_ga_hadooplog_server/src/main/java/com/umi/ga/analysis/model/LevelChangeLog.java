...
public class LevelChangeLog extends BaseEntity{

	private static final long serialVersionUID = 3229940352336066661L;
	...
	public Integer getNewRoleLevel() {
		return newRoleLevel;
	}

	public void setNewRoleLevel(Integer newRoleLevel) {
	...
	public void setSpendSecond(Integer spendSecond) {
