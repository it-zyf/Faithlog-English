...
function language() {
  ...
  if (cook == "Korean") {
    nov_choice = "请选择";
    nov_allaction = "全选/全不选";
    nov_selec = "项被选中";
    nov_allserver = "已选中所有选项";
    nov_servers = "区服号";
    nov_logtimes = "日志时间";
    nov_account = "账号ID";
    nov_devices = "设备号";
  ...
  $.ajax({
    ...
    success: function (obj) {
      ...
      $('#district_service').multiselect({
        buttonWidth: '73%',
        nonSelectedText: nov_choice,
        maxHeight: 200,
        numberDisplayed: 2,
        includeSelectAllOption: true,
        selectAllText: nov_allaction, //全选按钮显示的文本	
        nSelectedText: nov_selec,
        allSelectedText: nov_allserver,
...
function onread() {
  ...
  var step_number = $("#step_number").val(); //设备号
