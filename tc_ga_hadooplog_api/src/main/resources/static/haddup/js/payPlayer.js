  ...
  var t = $("#real-datatableAll").bootstrapTable({
    ...
    columns: [{
        ...
        formatter: function (value, row, index) {
          console.log(row)
          console.log(row.two)
          if (row.two != "" || row.two != undefined || row.two != null) {
            var twolv = row.two / row.num
            if (twolv != undefined || twolv != NaN) {
              twolv = (twolv * 100).toFixed(2)
              return twolv
            } else {
              return 0
            }
      ...
      },
      {
        ...
        width: 120,
        formatter: function (value, row, index) {
          if (row.three != "" || row.three != undefined || row.three != null) {
            var twolv = row.three / row.num
            if (twolv != undefined || twolv != NaN) {
              twolv = (twolv * 100).toFixed(2)
              return twolv
            } else {
      ...
      },
      {
        ...
        width: 150,
        formatter: function (value, row, index) {
          if (row.seven != "" || row.seven != undefined || row.seven != null) {
            var twolv = row.seven / row.num
            if (twolv != undefined || twolv != NaN) {
              twolv = (twolv * 100).toFixed(2)
              return twolv
            } else {
...

      {
        ...
        width: 150,
        formatter: function (value, row, index) {
          if (row.fourteen != "" || row.fourteen != undefined || row.fourteen != null) {
            var twolv = row.fourteen / row.num
            if (twolv != undefined || twolv != NaN) {
              twolv = (twolv * 100).toFixed(2)
              return twolv
            } else {
      ...
      },
      {
        ...
        width: 150,
        formatter: function (value, row, index) {
          if (row.thirty != "" || row.thirty != undefined || row.thirty != null) {
            var twolv = row.thirty / row.num
            if (twolv != undefined || twolv != NaN) {
              twolv = (twolv * 100).toFixed(2)
              return twolv
            } else {
      ...
      },
      {
        ...
        width: 150,
        formatter: function (value, row, index) {
          if (row.sixty != "" || row.sixty != undefined || row.sixty != null) {
            var twolv = row.sixty / row.num
            if (twolv != undefined || twolv != NaN) {
              twolv = (twolv * 100).toFixed(2)
              return twolv
            } else {
