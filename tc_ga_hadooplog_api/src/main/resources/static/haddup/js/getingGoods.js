...
function onblu() {
  ...
  retentionTable(texts, texte, auctionstate, mode, aggregate)
}
...
$(".List div").click(function () {
  ...
  var auctiontext = $(".click-item")[0].innerText
  if (auctiontext == "物品消耗") {
    auctionstate = 0
    mode = "物品消耗方式"
    aggregate = "物品消耗总量"
  } else if (auctiontext == "物品产出") {
    auctionstate = 1
    mode = "物品产出方式"
    aggregate = "物品产出总量"
  }
...
function homedata() {
  ...
  retentionTable(text1, textTime, auctionstate, mode, aggregate)
}

function retentionTable(startTime, endTime, auctionstate, mode, aggregate) {
