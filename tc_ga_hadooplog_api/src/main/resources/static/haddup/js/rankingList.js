...
function onblu() {
  ...
  retentionTable(seDate, rankingName)
}
...
$(".List div").click(function () {
  ...
  $(".list-group div").removeClass("click-item")
  $(".list-group").each(function (i, dom) {
    $(this).css("display", "none")
    if (i == dividx) {
      $(this).css("display", "block")
      $($(this).children("div").get(0)).addClass("click-item")
    }
  })
  $("#real-datatableAll").bootstrapTable('destroy');
  $('#real-datatableAll').css('display', 'none')
...
function retentionTable(seDate, rankingListName) {
  var rankingName = "总战力";
  if (rankingListName == undefined) {
    rankingName = "总战力"
  } else {
    rankingName = rankingListName
  }
  var value = $(".list-group .click-item").attr("id")
  if (value == undefined) {
    value = ""
  }
  ...
  t.on('load-success.bs.table', function (data) { //table加载成功后的监听函数
    ...
    var thinnerobjs = $(".th-inner"); //通过类名找到标签
    thinnerobjs[9].innerHTML = rankingName;
  });
}
