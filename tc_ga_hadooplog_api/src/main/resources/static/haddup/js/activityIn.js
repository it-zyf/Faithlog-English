...
function retentionTable(seDate) {
  ...
  var t = $("#real-datatableAll").bootstrapTable({
    url: requestURL + 'active_involved',
    method: 'post',
    dataType: "json",
    ...
    columns: [{
      ...
      {
        title: '参与率',
        field: 'participationRate1',
        align: 'center',
        width: 100,
      },
      {
        title: '打宝的平均次数',
        field: 'avgTreasureNum',
        align: 'center',
        width: 150,
      },
      {
