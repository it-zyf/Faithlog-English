...
function devicenumber(strat,end) {
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectNumOfPeople",//接口-设备总数
        async: true,
        data: {
            startTime:strat,
            endTime:end
...
function dataBottom(defaltDuraTime,defaltOneTime) {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectConfiguration",//接口-手机品牌
        async: true,
        data: {
...
function phoneBrands(startTime,endTime) {
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectBrand",//接口-手机品牌
        async: true,
        data: {
            startTime:startTime,
            endTime:endTime
...
function osVersion(startTime,endTime,ostype) {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectSystemVersion",//接口-操作系统版本
        async: true,
        data: {
            startTime:startTime,
            endTime:endTime,
...
function resolution(start,end) {
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectScreenResolution",//接口-分辨率
        async: true,
        data: {
            startTime:start,
            endTime:end
...
function storage(startTime,endTime) {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectRunMemory",//接口-内存
        async: true,
        data: {
            startTime:startTime,
            endTime:endTime,
...
function cpu(startTime,endTime) {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectCpuName",//接口-CPU
        async: true,
        data: {
            startTime:startTime,
            endTime:endTime,
...
function gpu(startTime,endTime) {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"frontEnd/selectGpuRender",//接口-GPU
        async: true,
        data: {
            startTime:startTime,
            endTime:endTime,
