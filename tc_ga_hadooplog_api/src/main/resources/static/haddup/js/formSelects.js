...
function _defineProperty(e, t, n) {
	...
	o.prototype.renderSelect = function(n, e, t) {
		...
		if(q[n].config.btns.length) {
			...
			a.push(['<dd lay-value="" class="' + J + '" style="background-color: #1a1a1a!important;">', this.renderBtns(n, null, "30px"), "</dd>", '<dd lay-value="" class="' + J + " " + W + '" style="background-color: #1a1a1a!important;">', '<i class="xm-iconfont icon-sousuo"></i>', '<input type="text" class="' + M + " " + y + '" placeholder="请搜索"/>', "</dd>"].join(""))
		} else {
