...
($ => {
  ...
  LOCALES['en-US'] = LOCALES.en = {
    ...
    formatRecordsPerPage (pageNumber) {
      return Utils.sprintf('每页显示  %s 条记录', pageNumber)
    },
    formatShowingRows (pageFrom, pageTo, totalRows) {
//      return Utils.sprintf('显示第  %s 到第 %s 条记录 ，共  %s 条记录', pageFrom, pageTo, totalRows)
    	return Utils.sprintf('显示第  %s 到第 %s 条记录', pageFrom, parseInt(pageFrom)+parseInt(20))
    },
    formatDetailPagination (totalRows) {
      return Utils.sprintf('每页显示  %s 条记录', totalRows)
    },
    formatSearch () {
      return 'Search'
    },
