...
function onblu() {
    ...
    retentionTable(serverSub, texts, texte, text6, text7)
}
...
function homedata() {
    ...
    $.ajax({
        ...
        success: function (ob) {
            // AddUser(ob);
            retentionTable(text5, text1, textTime, text6, text7)
            // $("#page-wrapper").mLoading("hide");
        }
    });
}

function retentionTable(text5, text1, textTime, text6, text7) {
