...
function onready2() {
    ...
    retentionTableQuery(serverSub, texts, texte, text6, text9, text7, text8, text4)
}
...
function retentionTableQuery(text5, text1, textTime, text6, text9, text7, text8, text4) {
    $("#pull-right").css("display", "block");
    $("#real-datatableAll").bootstrapTable('destroy');
    var t = $("#real-datatableAll").bootstrapTable({
        url: '../querySingleRowRoom.action',
