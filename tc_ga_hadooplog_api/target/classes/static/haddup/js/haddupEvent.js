    ...
    $('#selfBtn').click(function () {
        ...
        layer.open({
            ...
            yes: function(index, layero) {
                ...
                $.ajax({
                    type: "post",
                    url: "http://192.168.0.116:9110/saveCustomEvent",
                    async: false,
                    data:{
    ...
    $('#selfChangeBtn').click(function () {
        ...
        layer.open({
            ...
            yes: function(index, layero) {
                ...
                $.ajax({
                    type: "post",
                    url: allAnalysisRequestURL+"/updateCustomEvent",
                    async: false,
                    data:{
...
function change() {
    ...
    $.ajax({
        type: "get",
        url: allAnalysisRequestURL+"/selectAllEventList",
        async: false,
        success: function (obj) {
            //给自定义事件赋值
            for (var i = 0; i < obj.data.length; i++) {
...
function allEventData() {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"/selectCustomEvent",
        async: false,
        data:{
            startTime:startT,
            endTime:endT,
...
function changeEvent(){
    $.ajax({
        type: "get",
        url: allAnalysisRequestURL+"/selectCustomEventList",
        async: false,
        success: function (obj) {
...
function chartRequest(param) {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"/selectEventByEventId",
        async: true,
        data: {
            type: param,
            startTime: startT,
...
function searchEvent() {
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"/selectCustomEvent",//改变接口
        async: false,
        data:{
            condition:searchId,
            startTime:startT,
...
function deleteEvent(id){
    ...
    $.ajax({
        type: "post",
        url: allAnalysisRequestURL+"/deleteCustomEvent",
        async: false,
        data:{
            id:idParam
        },
