...
function language() {
  ...
  if (cook == "Korean") {
    cre_choice = "请选择";
    cre_allaction = "全选/全不选";
    cre_selec = "项被选中";
    cre_allserver = "已选中所有选项";
    cre_servers = "区服号";
    cre_logtimes = "日志时间";
    cre_account = "账号ID";
    cre_devices = "设备号";
  ...
  $.ajax({
    ...
    success: function (obj) {
      ...
      $('#district_service').multiselect({
        buttonWidth: '73%',
        nonSelectedText: cre_choice,
        maxHeight: 200,
        numberDisplayed: 2,
        includeSelectAllOption: true,
        selectAllText: cre_allaction, //全选按钮显示的文本	
        nSelectedText: cre_selec,
        allSelectedText: cre_allserver,
    ...
    columns: [{
      ...
      // },
      {
        ...
        formatter: function (value, row, index) {
          if (roleName[row.career]) {
            return roleName[row.career]
          } else {
            return row.career
          }
        }
